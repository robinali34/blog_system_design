...
1. **System Design Interview**: General system design problems
2. **Product Architecture Interview**: Architecture-focused design problems
3. **In-Domain Design Interview**: Domain-specific design problems
...
3. **Problem Navigation** (10-15 minutes)
   - Ask clarifying questions
   - Identify key requirements
   - Understand constraints
   - Define the problem scope

4. **Solution Design** (20-25 minutes)
   - High-level design
   - Component breakdown
...
9. **Design a URL Shortener (like bit.ly)**
...
21. **Design a Video Streaming Platform**
...
22. **Design a Ride-Sharing Service**
    - Driver and rider matching
    - Real-time location tracking
    - Route optimization
    - Pricing and payment

23. **Design a Recommendation System**
...
**Do:** Ask questions first, understand requirements, then design

### 2. Not Asking Questions

**Don't:** Assume you understand everything about the problem
**Do:** Ask about scale, constraints, requirements, and success criteria

### 3. Staying Too High-Level

**Don't:** Only discuss high-level architecture without diving into details
**Do:** Provide high-level overview, then deep dive into specific areas
...
**Do:** Consider failure scenarios and how to handle them

### 6. Poor Communication

**Don't:** Mumble through explanations or draw unclear diagrams
**Do:** Explain clearly, use the whiteboard effectively, label everything

### 7. Not Adapting to Feedback

**Don't:** Stick to your initial design even when feedback suggests changes
**Do:** Listen to feedback and adjust your approach
...
1. **You Drive the Conversation**: Don't wait for the interviewer to guide you - ask questions, propose solutions, discuss trade-offs
2. **Ask Questions**: Reduce ambiguity by asking clarifying questions about requirements, constraints, and goals
3. **Show Your Thought Process**: Explain your reasoning, not just your solution
4. **Consider the Big Picture**: Design solutions that work end-to-end, not just individual components
5. **Discuss Trade-offs**: Always consider alternatives and their trade-offs
