...
I am a fan of software architecture and system design, enjoying the career advance my knowledge in it and keep challenging myself with something new from time to time.
Here, you will find my path in system design, distributed systems, and scalable architectures; insights on design patterns, technical concepts; and my journey in preparing for system design interviews.
Have fun~
